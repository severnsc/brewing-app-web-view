	...
	render() {
		...
		return(
			<form style={styles.form} onSubmit={this.onSubmit}>
				...
				<label style={focus === "lab" ? labelFocusStyle : formStyles.label}>
					Yeast lab
					<input
						style={focus === "lab" ? inputFocusStyle : formStyles.input}
						name="lab"
						type="text"
						value={lab}
						onChange={this.handleChange}
				...
				<label style={focus === "number" ? labelFocusStyle : formStyles.label}>
					Yeast number (i.e. WLP001)
					<input
						style={focus === "number" ? inputFocusStyle : formStyles.input}
						name="number"
						type="text"
						value={number}
						onChange={this.handleChange}
				...
				<label style={focus === "type" ? labelFocusStyle : formStyles.label}>
					Type
					<select
				...
				<label style={focus === "dry" ? labelFocusStyle : formStyles.label}>
					Dry or liquid
					<select
						style={formStyles.select}
						name="dryOrLiquid"
