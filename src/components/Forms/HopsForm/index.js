	...
	render() {
		...
		return(
			<form style={styles.form} onSubmit={this.onSubmit}>
				...
				<label style={focus === "alphaAcids" ? labelFocusStyle : formStyles.label}>
					Alpha Acid Percentage
					<input
						style={focus === "alphaAcids" ? inputFocusStyle : formStyles.input}
						name="alphaAcids"
						type="number"
						step="0.1"
						value={alphaAcids}
				...
				<label style={focus === "countryOfOrigin" ? labelFocusStyle : formStyles.label}>
					Country of Origin
					<input
						style={focus === "countryOfOrigin" ? inputFocusStyle : formStyles.input}
